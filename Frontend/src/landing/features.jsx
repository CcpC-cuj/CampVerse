      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-800/60 rounded-lg p-8 transition-all duration-300 hover:shadow-cyan-500/50 hover:shadow-md">
            <div className="w-20 h-20 bg-[#9b5de5]/20 rounded-full flex items-center justify-center mb-6 text-white">
              <i className="ri-search-line ri-xl text-[#9b5de5]"></i>
            </div>
          ...
          {/* Feature 2 */}
          <div className="bg-gray-800/60 rounded-lg p-8 transition-all duration-300 hover:shadow-cyan-500/50 hover:shadow-md">
            <div className="w-16 h-16 bg-[#9b5de5]/20 rounded-full flex items-center justify-center mb-6">
              <i className="ri-user-add-line ri-xl text-[#9b5de5]"></i>
            </div>
          ...
          <div className="bg-gray-800/60 rounded-lg p-8 transition-all duration-300 hover:shadow-cyan-500/50 hover:shadow-md">
            <div className="w-16 h-16 bg-[#9b5de5]/20 rounded-full flex items-center justify-center mb-6">
              <i className="ri-group-line ri-xl text-[#9b5de5]"></i>
            </div>
