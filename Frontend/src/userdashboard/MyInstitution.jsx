    ...
    const fetchData = async () => {
      try {
        ...
        const [instData, membersData, eventsData, analyticsData] = await Promise.all([
          ...
          getInstitutionMembers(institutionId, 1, 20),
          getInstitutionEvents(institutionId, 1, 10, eventFilter),
          ...
          <div className="bg-gray-800/60 border border-gray-700 rounded-xl p-6 mb-6">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-400 text-sm capitalize">{institution?.type}</p>
