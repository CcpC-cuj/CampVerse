...
describe('Services Unit Tests', () => {
  ...
  describe('OTP Service', () => {
    ...
    it('should verify OTP successfully', async () => {
      ...
      // Execute
      const isValid = await otpServiceInstance.verify('test@example.com', '123456');
    ...
    it('should fail verification for invalid OTP', async () => {
      ...
      // Execute
      const isValid = await otpServiceInstance.verify('test@example.com', '654321');
  ...
  describe('JWT Token Service', () => {
    it('should generate JWT token', () => {
      ...
      // Execute
      const token = jwt.sign(mockPayload, process.env.JWT_SECRET, { expiresIn: '7d' });
      
      // Assertions
      expect(token).toBe(mockToken);
      expect(jwt.sign).toHaveBeenCalledWith(mockPayload, process.env.JWT_SECRET, { expiresIn: '7d' });
    });
